...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "max-h-[400px] scroll-py-1 overflow-x-hidden overflow-y-auto overscroll-contain",
        className
      )}
      {...props}
    />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground bg-muted border border-border px-1.5 py-0.5 rounded-sm ml-auto text-xs tracking-widest",
        className
      )}
      {...props}
    />
